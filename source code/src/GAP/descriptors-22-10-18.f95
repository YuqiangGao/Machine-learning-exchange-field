...
module descriptors_module
   ...
   integer, parameter, public :: DT_SOSD_EX         = 32
   integer, parameter, public :: DT_SOSD_3B_EX      = 33
   ...
   type sosd
      real(dp) :: cutoff
      real(dp) :: cutoff_transition_width
      real(dp) :: alpha, alpha_e, spin_sigma, atom_sigma, covariance_sigma0, central_weight
   ...
   type sosd_3b
      ...
      integer :: l_max, n_max, n_Z, n_species
      integer, dimension(:), allocatable :: species_Z, Z
      real(dp), dimension(:), allocatable :: r_basis_3b
      real(dp), dimension(:,:), allocatable :: transform_basis,cholesky_overlap_basis
...
#include "descriptors_noncommercial_types.inc"
...
#ifdef DESCRIPTORS_NONCOMMERCIAL
   public :: soap, sosd,sosd_3b, general_monomer, bispectrum_so4, bispectrum_so3, behler, distance_2b, &
...
#else
   public :: soap, sosd,sosd_3b, bispectrum_so4, bispectrum_so3, behler, distance_2b, &
        coordination, angle_3b, co_angle_3b, co_distance_2b, cosnx, trihis, water_monomer, &
   ...
   type descriptor
      ...
      type(sosd)            :: descriptor_sosd_ex
      type(sosd_3b)            :: descriptor_sosd_3b_ex
   ...
   interface initialise
      ...
      bond_real_space_initialise, transfer_initialise, com_dimer_initialise,  soap_express_initialise, sosd_ex_initialise,sosd_3b_ex_initialise
#else
      module procedure descriptor_initialise, RadialFunction_initialise, fourier_so4_initialise, &
      bispectrum_SO4_initialise, bispectrum_SO3_initialise, behler_initialise, distance_2b_initialise, &
      coordination_initialise, angle_3b_initialise, co_angle_3b_initialise, co_distance_2b_initialise, cosnx_initialise, trihis_initialise, &
      water_monomer_initialise, water_dimer_initialise, A2_dimer_initialise, AB_dimer_initialise, distance_Nb_initialise,  rdf_initialise, as_distance_2b_initialise, alex_initialise, &
      atom_real_space_initialise, power_so3_initialise, power_SO4_initialise, soap_initialise, soap_turbo_initialise,sosd_ex_initialise,sosd_3b_ex_initialise
#endif
   ...
   interface finalise
      ...
      bond_real_space_finalise, soap_express_finalise,sosd_ex_finalise,sosd_3b_ex_finalise
#else
      module procedure descriptor_finalise, descriptor_data_finalise, RadialFunction_finalise, fourier_so4_finalise, cplx_2d_array1_finalise, cplx_3d_array2_finalise, &
      bispectrum_SO4_finalise, bispectrum_SO3_finalise, behler_finalise, distance_2b_finalise, coordination_finalise, angle_3b_finalise, co_angle_3b_finalise, &
      co_distance_2b_finalise, cosnx_finalise, trihis_finalise, water_monomer_finalise, water_dimer_finalise, rdf_finalise, as_distance_2b_finalise,  alex_finalise, &
      A2_dimer_finalise, AB_dimer_finalise, atom_real_space_finalise, power_so3_finalise, power_SO4_finalise, soap_finalise, distance_Nb_finalise, soap_turbo_finalise,sosd_ex_finalise,sosd_3b_ex_finalise
#endif
   ...
   interface calc
      ...
      AN_monomer_calc,  soap_express_calc, general_monomer_calc, general_dimer_calc, general_trimer_calc,  molecule_lo_d_calc, com_dimer_calc, bond_real_space_calc,sosd_ex_calc,sosd_3b_ex_calc
#else
      module procedure descriptor_calc, descriptor_calc_array, bispectrum_SO4_calc, bispectrum_SO3_calc, behler_calc, distance_2b_calc, coordination_calc, angle_3b_calc, co_angle_3b_calc, &
      co_distance_2b_calc, cosnx_calc, trihis_calc, water_monomer_calc, water_dimer_calc, A2_dimer_calc, AB_dimer_calc,  atom_real_space_calc, &
      power_so3_calc, power_SO4_calc, soap_calc, rdf_calc, as_distance_2b_calc, &
      distance_Nb_calc, alex_calc, soap_turbo_calc, sosd_ex_calc, sosd_3b_ex_calc
   ...
   interface cutoff
      ...
      power_so3_cutoff, power_SO4_cutoff, soap_cutoff, alex_cutoff, distance_Nb_cutoff, rdf_cutoff, as_distance_2b_cutoff, soap_turbo_cutoff, sosd_ex_cutoff, sosd_3b_ex_cutoff, &
   ...
   interface descriptor_sizes
      ...
      alex_sizes, distance_Nb_sizes, soap_turbo_sizes, sosd_ex_sizes, sosd_3b_ex_sizes,  &
...
#include "descriptors_noncommercial.inc"
   ...
   function get_descriptor_type(args_str,error)
      ...
      logical :: is_bispectrum_so4, is_bispectrum_so3, is_behler, is_distance_2b, is_coordination, is_angle_3b, &
         ...
         is_molecule_lo_d, is_alex, is_com_dimer, is_distance_Nb, is_soap_express, is_soap_turbo, is_sosd_ex,is_sosd_3b_ex
      ...
      call param_register(params, 'sosd_ex', 'false', is_sosd_ex, help_string="Type of descriptor is sosd_ex.")
      call param_register(params, 'sosd_3b_ex', 'false', is_sosd_3b_ex, help_string="Type of descriptor is sosd_3b_ex.")
      ...
      is_distance_Nb, is_soap_express, is_soap_turbo, is_sosd_ex, is_sosd_3b_ex /) ) /= 1) then
      ...
      elseif( is_sosd_ex )  then
         get_descriptor_type = DT_SOSD_EX 
      elseif( is_sosd_3b_ex )  then
         get_descriptor_type = DT_SOSD_3B_EX 
      endif
   ...
   subroutine descriptor_initialise(this,args_str,error)
      ...
      case(DT_SOSD_EX)
         call initialise(this%descriptor_sosd_ex,args_str,error)
       case(DT_SOSD_3B_EX)
         call initialise(this%descriptor_sosd_3b_ex,args_str,error)
#ifdef DESCRIPTORS_NONCOMMERCIAL
   ...
   subroutine descriptor_finalise(this,error)
      ...
      selectcase(this%descriptor_type)
         ...
         case(DT_SOSD_EX)
            call  finalise(this%descriptor_sosd_ex,error)
         case(DT_SOSD_3B_EX)
            call  finalise(this%descriptor_sosd_3b_ex,error)
   ...
   endsubroutine soap_finalise
     ...
     subroutine sosd_ex_initialise(this,args_str,error)
      type(sosd), intent(inout) :: this
      character(len=*), intent(in) :: args_str
      integer, optional, intent(out) :: error
      ...
      call param_register(params, 'l_max', PARAM_MANDATORY, this%l_max, help_string="L_max (spherical harmonics basis band limit) for soap-type descriptors")
      call param_register(params, 'n_max', PARAM_MANDATORY, this%n_max, help_string="N_max (number of radial basis functions) for soap-type descriptors")
      call param_register(params, 'atom_sigma', PARAM_MANDATORY, this%atom_sigma, help_string="Width of atomic Gaussians for soap-type descriptors", altkey='atom_sigma')
      call param_register(params, 'spin_sigma', PARAM_MANDATORY, this%spin_sigma, help_string="Width of spin Gaussians for sosd-type descriptors")
      call param_register(params, 'central_weight', '1.0', this%central_weight, help_string="Weight of central atom in environment")
      call param_register(params, 'central_reference_all_species', 'F', this%central_reference_all_species, has_value_target=has_central_reference_all_species, &
           help_string="Place a Gaussian reference for all atom species densities."// &
           "By default (F) only consider when neighbour is the same species as centre")
     ...
     call print('2777')
      this%alpha = 0.5_dp / this%atom_sigma**2
      this%alpha_e = 0.5_dp / this%spin_sigma**2
   ...
   endsubroutine sosd_ex_initialise
   
   subroutine sosd_ex_finalise(this,error)
      type(sosd), intent(inout) :: this
      integer, optional, intent(out) :: error
   ...
   endsubroutine sosd_ex_finalise

     subroutine sosd_3b_ex_initialise(this,args_str,error)
      type(sosd_3b), intent(inout) :: this
      character(len=*), intent(in) :: args_str
      integer, optional, intent(out) :: error
   ...
   call print('2992')
     ...
     call print('2777')
      ...
      allocate(this%r_basis_3b(this%n_max), this%transform_basis(this%n_max,this%n_max), &
         covariance_basis(this%n_max,this%n_max), overlap_basis(this%n_max,this%n_max), this%cholesky_overlap_basis(this%n_max,this%n_max))
      ...
      !enddo
     call print('3020')
      this%r_basis_3b(1) = 0.0_dp
      do i = 2, this%n_max
         this%r_basis_3b(i)  = this%r_basis_3b(i-1) + spacing_basis
      enddo

      do i = 1, this%n_max
         do j = 1, this%n_max
            covariance_basis(j,i) = exp(-alpha_basis * (this%r_basis_3b(i) - this%r_basis_3b(j))**2)
            !overlap_basis(j,i) = exp(-0.5_dp * alpha_basis* (this%r_basis(i) - this%r_basis(j))**2) * ( 1.0_dp + erf( sqrt(alpha_basis/2.0_dp) * (this%r_basis(i) + this%r_basis(j)) ) )
            !print*, 'A', exp( -alpha_basis*(this%r_basis(i)**2+this%r_basis(j)**2) )
            !print*, 'B', sqrt(2.0_dp) * alpha_basis**1.5_dp * (this%r_basis(i) + this%r_basis(j))
            !print*, 'C', alpha_basis*exp(0.5_dp * alpha_basis * (this%r_basis(i) + this%r_basis(j))**2)*sqrt(PI)*(1.0_dp + alpha_basis*(this%r_basis(i) + this%r_basis(j))**2 )
            ...
            overlap_basis(j,i) = ( exp( -alpha_basis*(this%r_basis_3b(i)**2+this%r_basis_3b(j)**2) ) * &
               sqrt(2.0_dp) * alpha_basis**1.5_dp * (this%r_basis_3b(i) + this%r_basis_3b(j)) + &
               alpha_basis*exp(-0.5_dp * alpha_basis * (this%r_basis_3b(i) - this%r_basis_3b(j))**2)*sqrt(PI)*(1.0_dp + alpha_basis*(this%r_basis_3b(i) + this%r_basis_3b(j))**2 ) * &
               ( 1.0_dp + erf( sqrt(alpha_basis/2.0_dp) * (this%r_basis_3b(i) + this%r_basis_3b(j)) ) ) )
         enddo
      enddo
     call print('2817')
      !overlap_basis = overlap_basis * sqrt(pi / ( 8.0_dp * alpha_basis ) )
   ...
   endsubroutine sosd_3b_ex_initialise
   
   subroutine sosd_3b_ex_finalise(this,error)
      type(sosd_3b), intent(inout) :: this
      integer, optional, intent(out) :: error
    ...
    call print('3091')
     ...
     call print('3092')
      ...
      this%n_species = 0
     call print('3099')
      if(allocated(this%r_basis_3b)) deallocate(this%r_basis_3b)
call print('3101')
      if(allocated(this%transform_basis)) deallocate(this%transform_basis)
call print('3103')
     ! if(allocated(this%cholesky_overlap_basis)) deallocate(this%cholesky_overlap_basis)
...
call print('3109')
   ...
   endsubroutine sosd_3b_ex_finalise
   ...
   subroutine descriptor_calc(this,at,descriptor_out,do_descriptor,do_grad_descriptor,args_str,error)
      ...
      selectcase(this%descriptor_type)
         ...
         case(DT_SOSD_EX)
            call calc(this%descriptor_sosd_ex,at,descriptor_out,do_descriptor,do_grad_descriptor,args_str,error)
          case(DT_SOSD_3B_EX)
            call calc(this%descriptor_sosd_3b_ex,at,descriptor_out,do_descriptor,do_grad_descriptor,args_str,error)
         case(DT_RDF)
...
!if(r_ij <3.5_dp) cycle
   ...
   endsubroutine power_SO4_calc
    ...
    subroutine soap_calc(this,at,descriptor_out,do_descriptor,do_grad_descriptor,args_str,error)
      ...
      real(dp), dimension(3) :: u_ij, d_ij, e_ij
             ...
             do l=0, this%l_max 
                  i_pow=l+1
                	...
                	t_g_i(3*(a-1)+alpha,l) = tmpgrad_i  
                        ...
                        tmpgrad_i=0.0_dp        
                      enddo  ! alpha
                    !  call print('====n_species=================='//this%n_species)
                 ...
                 !    i_species = rs_index(2,ia)
                 !    
                 !    t_f_r(ia, 1) = fourier_so3_r(l,a,i_species)
                 !    t_f_i(ia, 1) = fourier_so3_i(l,a,i_species)
                 ! enddo
                 ! call dgemm('N','T',this%n_max*3, this%n_max*this%n_species, 2*l+1, 1.0_dp, &
                 !    t_g_r(1,1), size(t_g_r,1), t_f_r(1,1), size(t_f_r,1), 0.0_dp, t_g_f_rr(1,1), size(t_g_f_rr, 1))
                 ! call dgemm('N','T',this%n_max*3, this%n_max*this%n_species, 2*l+1, 1.0_dp, &
                 ...
                 ! do ia = 1, this%n_species*this%n_max
                   ...
                   !  i_species = rs_index(2,ia)
                    ! do jb = 1, ia !this%n_species*this%n_max !ia
                    !    b = rs_index(1,jb)
                    !    j_species = rs_index(2,jb)   only take the down trianglar part  not the diagonal one  C_m*dC_n/dx
                   
                
                

                        !if(this%diagonal_radial .and. a /= b) cycle
                      !  grad_descriptor_i(i_pow, 1:3) =  t_g_r(3*(a-1)+1:3*a)
...
!$omp end parallel
   ...
   endsubroutine sosd_ex_calc
    ...
    subroutine sosd_3b_ex_calc(this,at,descriptor_out,do_descriptor,do_grad_descriptor,args_str,error)
      ...
      type(cplx_1d), dimension(:), allocatable, save :: SphericalY_ij, SphericalE_ij,SphericalE_i 
      type(cplx_2d), dimension(:), allocatable, save :: grad_SphericalY_ij
       complex(dp) :: spherical0
      ...
      integer :: d,x, i, j, n, a, b, k, l, m, i_pow, i_coeff, l_n_neighbours, n_i, &
         n_descriptors, n_cross, i_species, j_species, ia, jb, i_desc_i, &
         xml_version, sum_l_n_neighbours, i_pair, i_pair_i, n_index,l1,l2,m1,m2,nn
      integer, dimension(3) :: shift_ij
      integer, dimension(:), allocatable :: i_desc
      integer, dimension(:,:), allocatable :: rs_index
      real(dp) :: r_ij, arg_bess, arg_bess_e, mo_spher_bess_fi_ki_0, mo_spher_bess_fi_ki_l, mo_spher_bess_fi_ki_lm, mo_spher_bess_fi_ki_lmm, mo_spher_bess_fi_ki_l_e, mo_spher_bess_fi_ki_l_em, mo_spher_bess_fi_ki_l_emm, mo_spher_bess_fi_ki_lp, &
      ...
      type(real_2d_array), dimension(:), allocatable :: global_grad_fourier_so3_r_array, global_grad_fourier_so3_i_array
      integer, dimension(total_elements) :: species_map
      complex(dp), allocatable, save :: sphericalycartesian_all_t(:,:), gradsphericalycartesian_all_t(:,:,:),sphericalycartesian_all_e(:,:),sphericalycartesian_all_ei(:,:)
      complex(dp) :: g_tmp(3),c_tmp
      integer :: max_n_neigh
!$omp threadprivate(radial_fun, radial_coefficient, grad_radial_fun, grad_radial_coefficient)
!$omp threadprivate(sphericalycartesian_all_t, gradsphericalycartesian_all_t)
...
!$omp parallel default(none) shared(this,my_do_grad_descriptor,d,max_n_neigh) private(i_species, a, l, n_i)
      ...
      allocate(radial_fun(0:this%l_max, this%n_max), radial_e_fun(0:this%l_max) , radial_coefficient(0:this%l_max, this%n_max)) 
      !SPEED allocate(fourier_so3(0:this%l_max,this%n_max,this%n_species), SphericalY_ij(0:this%l_max))
      allocate(fourier_so3_r(0:this%l_max,this%n_max,this%n_species), fourier_so3_i(0:this%l_max,this%n_max,this%n_species), SphericalE_ij(0:this%l_max), SphericalY_ij(0:this%l_max),SphericalE_i(0:this%l_max))
      ...
      do i = 1, at%N
         ...
         do i_species = 1, this%n_species
            do a = 1, this%n_max
               !SPEED fourier_so3(0,a,i_species)%m(0) = radial_coefficient(0,a) * SphericalYCartesian(0,0,(/0.0_dp, 0.0_dp, 0.0_dp/))
               if( this%central_reference_all_species .or. this%species_Z(i_species) == at%Z(i) .or. this%species_Z(i_species) == 0 ) then
                  fourier_so3_r(0,a,i_species)%m(:) = this%central_weight * real(radial_coefficient(0,a) * SphericalYCartesian(0,0,(/0.0_dp, 0.0_dp, 0.0_dp/)), dp)
                  fourier_so3_i(0,a,i_species)%m(:) = this%central_weight * aimag(radial_coefficient(0,a) * SphericalYCartesian(0,0,(/0.0_dp, 0.0_dp, 0.0_dp/)))
               else
...
! soap_calc 20 takes 0.0052 s
	    ...
	    SphericalYCartesian_all_e = SphericalYCartesian_all(this%l_max, e_j)
		  ...
		  SphericalE_ij(l)%m(m) = SphericalYCartesian_all_e(l,m)
            ...
            enddo
             norm_mj=sqrt(m_j(1)**2+m_j(2)**2+m_j(3)**2)
     do nk= n+1, n_neighbours(at,i)
                k = neighbour(at, i, nk, distance = r_ik, cosines=u_ik, diff=d_ik, e_ij=e_ik, e_i=e_i, e_k=e_k,m_k=m_k, shift=shift_ik)  
              ...
              do  l=0, this%l_max
                     ...
                     !SPEED if(my_do_grad_descriptor) grad_fourier_so3(l,a,n_i)%mm(:,m) = grad_fourier_so3(l,a,n_i)%mm(:,m) + &
                     !SPEED    grad_radial_coefficient(l,a) * SphericalY_ij(l)%m(m) * u_ij + radial_coefficient(l,a) * grad_SphericalY_ij(l)%mm(:,m)
                    c_tmp = 1/sqrt(4*PI)*radial_coefficient(0,a) * SphericalY_ij(0)%m(0) *(4/mo_spher_bess_fi_ki_0)*radial_e_fun(l)*(-1)**m*SphericalE_ij(l)%m(-m)
                       
                     fourier_so3_r(l,a,i_species)%m(m) = fourier_so3_r(l,a,i_species)%m(m) + real(c_tmp)
                     fourier_so3_i(l,a,i_species)%m(m) = fourier_so3_i(l,a,i_species)%m(m) + aimag(c_tmp) 
                   enddo
                     if(my_do_grad_descriptor) then
                        do m=-l,l
                        
                          g_tmp(:) =   1/sqrt(4*PI)*radial_coefficient(0,a) * SphericalY_ij(0)%m(0) *(4/mo_spher_bess_fi_ki_0)*radial_e_fun(l)*(-1)**m*grad_SphericalY_ij(l)%mm(:,-m)/norm_mj
               ...
               enddo   ! l
            enddo   !  a
        enddo ! n_i   this is loop over all of the neighbour of atom i  n_i
...
!   endsubroutine distance_Nb_calc_neighbour_loop
   ...
   function descriptor_dimensions(this,error)
      ...
      selectcase(this%descriptor_type)
         ...
         case(DT_SOSD_EX)
         descriptor_dimensions = sosd_ex_dimensions(this%descriptor_sosd_ex,error)
         case(DT_SOSD_3B_EX)
         descriptor_dimensions = sosd_3b_ex_dimensions(this%descriptor_sosd_3b_ex,error)
         case(DT_RDF)
   ...
   function soap_dimensions(this,error) result(i)
     ...
     function sosd_ex_dimensions(this,error) result(i)
      type(sosd), intent(in) :: this
      integer, optional, intent(out) :: error
      integer :: i
      ...
      if(this%diagonal_radial) then
         ...
         i = (this%l_max+1) *  (this%n_max*this%n_species)
      endif

   endfunction sosd_ex_dimensions
  
   function sosd_3b_ex_dimensions(this,error) result(i)
      type(sosd_3b), intent(in) :: this
      integer, optional, intent(out) :: error
      integer :: i,l,l1,l2,m1,m2,count
      ...
      do l1=0, this%l_max
         do m1=-l1,l1
           do l2=0,this%l_max
             do m2=-l2,l2
               do l=0,this%l_max
                 if(abs(l1-l2) <= l .and. l <= l1+l2)  then
                      count= count+1
                 endif
                enddo !l
              enddo !m2
      ...
      i =  count * this%n_species * this%n_max*( this%n_species * this%n_max+1) / 2    + 1
      !i = (this%l_max+1) * this%n_max**2 * this%n_species**2 + 1
     ! if(this%diagonal_radial) then
     !    i = (this%l_max+1) * this%n_max * this%n_species * (this%n_species+1) / 2 + 1
     ! else
   ...
   endfunction sosd_3b_ex_dimensions
   ...
   function descriptor_cutoff(this,error)
      ...
      selectcase(this%descriptor_type)
        ...
        case(DT_SOSD_EX)
            descriptor_cutoff = cutoff(this%descriptor_sosd_ex,error)
         case(DT_SOSD_3B_EX)
            descriptor_cutoff = cutoff(this%descriptor_sosd_3b_ex,error)
         case(DT_RDF)
   ...
   function sosd_ex_cutoff(this,error) 
      type(sosd), intent(in) :: this
      integer, optional, intent(out) :: error  
      real(dp) :: sosd_ex_cutoff
      ...
      sosd_ex_cutoff = this%cutoff

   endfunction sosd_ex_cutoff
  
   function sosd_3b_ex_cutoff(this,error) 
      type(sosd_3b), intent(in) :: this
      integer, optional, intent(out) :: error  
      real(dp) :: sosd_3b_ex_cutoff
      ...
      sosd_3b_ex_cutoff = this%cutoff

   endfunction sosd_3b_ex_cutoff
      ...
      selectcase(this%descriptor_type)
         ...
         case(DT_SOAP)
            call soap_sizes(this%descriptor_soap,at, &
               n_descriptors,n_cross,mask=mask,n_index=n_index,error=error)
         case(DT_SOSD_EX)
         call sosd_ex_sizes(this%descriptor_sosd_ex,at, &
               n_descriptors,n_cross,mask=mask,n_index=n_index,error=error)
          case(DT_SOSD_3B_EX)
         call sosd_3b_ex_sizes(this%descriptor_sosd_3b_ex,at, &
               n_descriptors,n_cross,mask=mask,n_index=n_index,error=error)
         case(DT_RDF)
...
call print("mask present ? "//present(mask))   
  ...
  subroutine sosd_ex_sizes(this,at,n_descriptors,n_cross,mask,n_index,error)
      type(sosd), intent(in) :: this
      type(atoms), intent(in) :: at  
      integer, intent(out) :: n_descriptors, n_cross  
      logical, dimension(:), intent(in), optional :: mask  
   ...
   endsubroutine sosd_ex_sizes

    subroutine sosd_3b_ex_sizes(this,at,n_descriptors,n_cross,mask,n_index,error)
      type(sosd_3b), intent(in) :: this
      type(atoms), intent(in) :: at  
      integer, intent(out) :: n_descriptors, n_cross  
      logical, dimension(:), intent(in), optional :: mask  
   ...
   endsubroutine sosd_3b_ex_sizes
   ...
   function descriptor_n_permutations(this,error)
      ...
      selectcase(this%descriptor_type)
         case(DT_BISPECTRUM_SO4,DT_BISPECTRUM_SO3,DT_BEHLER,DT_DISTANCE_2b,DT_COORDINATION, &
            ...
            DT_ATOM_REAL_SPACE,DT_POWER_SO3,DT_POWER_SO4,DT_SOAP,DT_SOSD_EX,DT_SOSD_3B_EX,DT_RDF, DT_ALEX, DT_COM_DIMER, &
