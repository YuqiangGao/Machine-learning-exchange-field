...
!!!!! end grad
  ...
  subroutine sosd_3b_ex_calc(this,at,descriptor_out,do_descriptor,do_grad_descriptor,args_str,error)
      ...
      complex(dp) :: g_tmp(3),c_tmp
      integer :: max_n_neigh
!$omp threadprivate(radial_fun,radial_e_fun, radial_coefficient_j,radial_coefficient_k, grad_radial_fun, grad_radial_coefficient)
!$omp threadprivate(sphericalycartesian_all_t,sphericalycartesian_all_e,sphericalycartesian_all_tk,sphericalycartesian_all_ek,sphericalycartesian_all_ei, gradsphericalycartesian_all_t)
!$omp threadprivate(fourier_so3_r, fourier_so3_i)
!$omp threadprivate(SphericalY_ij,grad_SphericalY_ij,SphericalE_ij, SphericalE_ik, SphericalY_ik, SphericalE_i)
!$omp threadprivate(descriptor_i, grad_descriptor_i)
!$omp threadprivate(grad_fourier_so3_r, grad_fourier_so3_i)
...
!$omp parallel do schedule(dynamic) default(none) shared(this, at, descriptor_out, my_do_descriptor, my_do_grad_descriptor, d, i_desc, species_map, rs_index, do_two_l_plus_one) &
!$omp shared(global_grad_fourier_so3_r_array, global_grad_fourier_so3_i_array, norm_radial_decay) &
!$omp private(i, j, i_species, j_species, a, b, l, m, n, n_i, r_ij,e_ij, u_ij,d_ik, e_i, e_j, m_j, r_ik, e_ik,u_ik,e_k, m_k, d_ij, shift_ij) &
!$omp private(shift_ik,norm_mj,norm_mk,g_tmp, i_pow, i_coeff, ia, jb, alpha, i_desc_i) &
!$omp private(c_tmp) &
!$omp private(t_g_r, t_g_i, t_f_r, t_f_i, t_g_f_rr, t_g_f_ii) &
!$omp private(f_cut, df_cut, arg_bess, exp_p, exp_m, mo_spher_bess_fi_ki_l, mo_spher_bess_fi_ki_lp, mo_spher_bess_fi_ki_lm, mo_spher_bess_fi_ki_lmm, norm_descriptor_i) &
!$omp private(arg_bess_e, mo_spher_bess_fi_ki_0,mo_spher_bess_fi_ki_l_e,mo_spher_bess_fi_ki_l_em,mo_spher_bess_fi_ki_l_emm) &
!$omp private(radial_decay, dradial_decay) &
!$omp reduction(+:global_fourier_so3_r_array,global_fourier_so3_i_array,descriptor_out,i_desc)
      do i = 1, at%N
                       ...
                       do l2=0, this%l_max
                         do l=0, this%l_max
                          ...
                          do m1=-l1,l1
                           ...
                           c_tmp  = radial_coefficient_j(0,a) * SphericalY_ij(0)%m(0)*radial_coefficient_k(0,b) * SphericalY_ik(0)%m(0) *(4/mo_spher_bess_fi_ki_0)**3*sqrt(real(1/(4*real(l)+2)))*radial_e_fun(l)*radial_e_fun(l1)*radial_e_fun(l2)* cg_calculate(l1,m1,l2,m2,l,m1+m2)*&
...
!   endsubroutine distance_Nb_calc_neighbour_loop
   ...
   function soap_dimensions(this,error) result(i)
     ...
     function sosd_ex_dimensions(this,error) result(i)
      ...
      if(this%diagonal_radial) then
         ...
         i = (this%l_max+1) *  (this%n_max*this%n_species)*2
      endif
   ...
   function sosd_3b_ex_dimensions(this,error) result(i)
      type(sosd_3b), intent(in) :: this
      integer, optional, intent(out) :: error
      integer :: i,l,l1,l2,m1,m2,count, a, b
